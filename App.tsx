...
const demoData: ResumeData = {
  personalInfo: {
    fullName: "kuppusamy v",
    email: "appuv9064@gmail.com",
    phoneNumber: "9944457383",
    address: "tindivanam, NY",
    linkedIn: "https://linkedin.com/in/jane-smith",
    portfolio: "https://janesmith.dev",
    photoUrl: "/my photo.jpeg",
    ...
    <div className="bg-slate-100 text-slate-800 font-sans p-4 md:p-8">
      ...
      <footer className="text-center mt-12 py-4 max-w-screen-xl mx-auto">
        <p className="text-sm text-slate-500">
          Powered by KUPPUSAMY V | &copy; 2025 AI Resume Builder. All rights reserved.
        </p>
      </footer>
    </div>
  );
